...
export const QUANTITY_OPTIONS = [
  ...
  {
    value: 0.5,
    label: "0.5L — અડધો લિટર",
  },

  {
    value: 0.75,
    label: "0.75L — પોણો લિટર",
  },
...
export function getQuantityLabel(
  ...
  const enMap: Record<number, string> = {
    ...
    0.75: "0.75L — Three Quarter Liter",

    1: "1L — One Liter",

    1.5: "1.5L — One and Half Liter",

    2: "2L — Two Liter",

    2.5: "2.5L — Two and Half Liter",
